...
rt_err_t usbh_lwip_eth_device_linkchange(struct eth_device* dev, rt_bool_t up)
{
    if (up == RT_TRUE)
...
void usbh_cdc_ecm_run(struct usbh_cdc_ecm *cdc_ecm_class)
{
    ...
    usbh_lwip_eth_device_linkchange(&g_cdc_ecm_dev, RT_TRUE);
...
void usbh_rndis_run(struct usbh_rndis *rndis_class)
{
    ...
    usbh_lwip_eth_device_linkchange(&g_rndis_dev, RT_TRUE);
...
void usbh_cdc_ncm_run(struct usbh_cdc_ncm *cdc_ncm_class)
{
    ...
    usbh_lwip_eth_device_linkchange(&g_cdc_ncm_dev, RT_TRUE);
...
void usbh_asix_run(struct usbh_asix *asix_class)
{
    ...
    usbh_lwip_eth_device_linkchange(&g_asix_dev, RT_TRUE);
...
void usbh_rtl8152_run(struct usbh_rtl8152 *rtl8152_class)
{
    ...
    usbh_lwip_eth_device_linkchange(&g_rtl8152_dev, RT_TRUE);
